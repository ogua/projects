			...
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					<div class="row">
						<div class="col-md-2">
							...
							<div class="panel panel-body">
								<ul>
									...
									<a href="uprofile.php" class="btn btn-info" style="width:100%;">User Profile</a></li>
									<hr style="2px solid #fff;">
									<li><a href="booking2.php"><img src="images/bookim.jpg" class="img-thumbnail" width="100" height="100"></a><a href="booking2.php" class="btn btn-success" style="width:100%;">Book Now</a></li>
						...
						<div class="col-md-10">
							<div class="panel panel-info">
							<div class="panel panel-heading">User Information</div>
								<?php
									include_once('db.php');
								...
								<?php
									include_once('db.php');
									$sqls = "SELECT `image` FROM `booking` WHERE `userid`  = '".$_SESSION['id']."'";
									...
									<div class="col-md-8">
										<form method="post" action="">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="<?php echo $row['name']; ?>" name="uname" id="uname" required>
											</div>
											<div class="form-group">
												<label>Email</label>
												<input type="text" class="form-control" value="<?php echo $row['email']; ?>" name="uemail" id="uemail" required>
											</div>
											<div class="form-group">
												<label>Phone Number</label>
												<input type="text" class="form-control" value="<?php echo $row['phone']; ?>" name="uphone" id="uphone" required>
											</div>
											<div class="form-group">
												<input input="submit" id="updateinfo" class="btn btn-info" value="Update Info"/>
											</div>
										</form>
									</div>
									<div class="col-md-4">
										<img src="images/<?php echo $img; ?>" height="200" width="200" class="img-thmbnail img-circle">
									</div>
								</div>
							</div>
							<div class="panel panel-footer"></div>
			...
			$("#updateinfo").on("click",function(e){
				e.preventDefault();
					...
					$.ajax({
						url: 'action.php',
						type: 'post',
						data: {UpadetForm: 1, uname: uname, uemail: uemail, uphone: uphone, id: id},
