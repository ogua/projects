						...
						<div class="col-md-6">
							<form method="post" action="" id="addagent" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="eloca" name="eloca" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="ehost" name="ehost" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Add Event">
								</div>
								<div class="form-group">
									<div class="col-md-12">
