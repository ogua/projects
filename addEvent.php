						...
						<div class="col-md-6">
							<form method="post" action="" id="addagent" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="eloca" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Contact</label>
									<input type="text" class="form-control" name="econt" required>
								</div>
								
								<div class="form-group">
									<label>Event Hosted By</label>
									<input type="text" class="form-control" name="ehost" required>
								</div>
								<div class="form-group">
									<label>Event Description</label>
									<textarea class="form-control" cols="3" rows="4" style="resize:none;" name="edsc"></textarea>
								</div>
								<div class="form-group">
