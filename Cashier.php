...
<body class="back">
    <h1 class="text-center" style="color: #42327a;">Cashier</h1>
	...
	<div class="form-group">
       ...
       <label style="color:#d8bc35;">Drugs Cost</label>						
		   ...
		   <div class="col-sm-6 col-sm-offset-3" id="printRec" style="boder:1px dotted #42327a; border-style:double;height:320px;margin-bottom:20px;">
					<center style="color:white;" style="margin-top:20px;">UPSA CLINIC</center>
					<ul class="list-inline text-center">
					<li><h4>University Of Professional Studies Clinic</h4></li>
