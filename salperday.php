...
<head>
  ...
  <title>:: View Sales Per Day</title>
    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">View Sales Per Day &nbsp;<span><img src="images/prescri.jpg" class="img-circle" height="50" width="50"></span></div>
...
<script>
		$('document').ready(function(){
			...
			$.ajax({
						url: "./AdminCode/SalePDay.php",
						method: "post",
						data: {results: results, resultss: resultss},
						success: function(response){
							$("#getTran4").html(response);
						}
					});
		});
		});
