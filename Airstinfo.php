...
<head>
  ...
  <title>:: Artistes Information</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
		<h3 style="color:whit">Artist Information</h3>
		<div class="row">
			<div class="col-md-3" style="border:1px solid gren;">
				<img src="images/<?php echo $row['images']; ?>" alt="" width="200">
			</div>
			<div class="col-md-8" style="border:1px solid gren;">
				<div class="grid blog-desc">
								<a href="artistEditinfo.php" class="btn btn-info" title="Edit Information"><i class="fa fa-edit"></i></a>
								<h4>
								...
								<p>Album: <?php echo $row['albums']; ?></p>
								<p>Awards: <?php echo $row['awards']; ?></p>
