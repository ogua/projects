    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">View Sales Per Product &nbsp;<span><img src="images/prescri.jpg" class="img-circle" height="50" width="50"></span></div>
				<div class="panel panel-body">
					 <div class="col-md-6 col-md-offset-3">
<input type="text" style="border-top-right-radius:25px;border-top-left-radius:25px;" id="tsc" name="tsc" class="form-control" placeholder="SEARCH BY PRODUCT NAME"/>
					 </div>
				...
				<?php
					     include_once('db.php');
						 $sqli2 = "SELECT BillId, `name`,`Price`,SUM(`Quantity`),SUM(`Total`),`datetime` FROM sale GROUP BY `dates`";
...
<script>
		$('document').ready(function(){
			$("#tsc").keyup(function(){
				var transac3 = $(this).val();
				if(transac3 !==""){
					$.ajax({
						url: "./AdminCode/SalePProductLive.php",
						method: "post",
						data: {transac3: transac3},
					...
					$.ajax({
						url: "./AdminCode/SalePProduct.php",
						method: "post",
						success: function(response){
							$("#getTran3").html(response);
						}
