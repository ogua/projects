								...
								<ul class="dropdown-menu">
										<div style="width:500px;">
												<div class="panel-success">
														...
														<div class="panel-footer" style="height:50px;"><a href="cart.php" class="btn btn-danger pull-right btn-xs">CheckOut</a></div>
												</div>
										</div>
								</ul>---->
						</li>
						<li><a href="#"  class="dropdown-toggle" data-toggle="dropdown" style="margin-right:10px;"><span class="glyphicon glyphicon-user"></span>
						<?php 
						include_once("db.php");
						if($_SESSION['id'] =="")
						{
