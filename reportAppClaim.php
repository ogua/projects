    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading"><h3>Report For Agents</h3>
			...
			<div class="table-responsive">
				<button class="btn btn-default">Total Agent &nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button>	
		...
		$('document').ready(function(){
			$("#send").click(function(){
				...
				$.ajax({
					url: 'action.php',
					type: 'POST',
					data: {AgentReport: 1, tfrm: tfrm, tto: tto},
