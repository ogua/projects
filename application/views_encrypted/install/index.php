        ...
        <div class="boxed">
            ...
            <div id="page-content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <center><img id="logo-header" src="<?php echo base_url(); ?>uploads/images/kandiums_thumbnail.jpg" alt="Logo" class="img-responsive" style="width:100px;"></center>
...
4 or over
                                            ...
                                            <!--Second tab-->
                                            <div id="demo-bv-tab2" class="tab-pa
ne fade">
                                                <div class="form-group">
                                                    <label class="col-lg-3 contr
ol-label">Database Name</label>
                                                    <div class="col-lg-7">
                                                        <input type="text" place
holder="Database Name" name="db_name" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 contr
ol-label">User name</label>
                                                    <div class="col-lg-7">
                                                        <input type="text" place
holder="User Name" name="db_uname" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 contr
ol-label">Password</label>
                                                    <div class="col-lg-7">
                                                        <input type="password" p
laceholder="Password" name="db_password" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 contr
ol-label">Host Name</label>
                                                    <div class="col-lg-7">
                                                        <input type="text" place
holder="Host Name" name="db_hname" class="form-control">
                                                    </div>
                                                </div>
                                            </div>

                                            <!--Third tab-->
                                            <div id="demo-bv-tab3" class="tab-pa
ne">
                                                <div class="form-group">
                                                    <label class="col-lg-3 contr
ol-label">Admin E-mail</label>
                                                    <div class="col-lg-7">
                                                        <input type="text" place
holder="Admin E-mail" name="email" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 contr
ol-label">Login password</label>
                                                    <div class="col-lg-7">
                                                        <input type="password" p
laceholder="Login password" name="password" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                <?php error_reporting(0)?>
                                            <!--Fourth tab-->
                                            <div id="demo-bv-tab4" class="tab-pa
ne  mar-btm text-center">
                                                <h4>Thank you</h4>
                                                <p class="text-muted rmb" style=
"display:block;">
                                                        Thank you for installing
 "Kandi User Management System". Best wishes for the next
                                                        <h5>It takes about 2-3 M
unites</h5>
                                                 </p>

                                                <div class="ads" style="display:
none;">

                                                    <p class="text-muted">Please
 click on the following links for visiting Your Application</p>
                                                    <a class="btn btn-dark" targ
et="_blank" href="<?php echo base_url() ?>index.php/dashboard">Admin Panel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
background-color: #fff;">
                                        <div class="box-inline">
                                            <button type="button" class="previou
s btn btn-dark">
                                                <i class="fa fa-step-backward" s
tyle="margin-right:6px;"></i>Previous
                                            </button>
                                            <?php if($can == 'ok'){ ?>
                                            <button type="button" class="next bt
n btn btn-success">
                                                Next<i class="fa fa-step-forward
" style="margin-left:7px;"></i>
                                            </button>
                                            <button type="button" class="finish
btn btn-success submitter" disabled>Install Kandi UMS</button>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <center> 2015 &copy; All Rights Reserved @ <a href="abou
t:blank">Kandi UMS </a></center>
                    </div>
                                ...
                                message: 'There are problems in your server file permissions and configuration. Fix them and try again.'
                                        ...
                                        /*db_password: {
                                                validators: {
                                                        notEmpty: {
                                                                message: 'This F
ield is required and cannot be empty'
                                                        }
                                                }
                                        },*/
                                        db_hname: {
