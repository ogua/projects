                ...
                <script>
                    ...
                    $(function () {
                        Highcharts.setOptions({
                            colors: ['#DC143C', '#55141C', '#F6C9CC', '#8B5F65',
 '#822b01', '#B03060', '#00E5EE', '#4A777A',
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <script>
                    ...
                    $(function () {
                        Highcharts.setOptions({
                            colors: ['#350082', '#810380', '#b20105', '#026473',
 '#067401', '#822b01', '#ae0344', '#0f09d5',
                        ...
                        $('#district_ins').highcharts({
                            ...
                            drilldown: {
                                series: [
                                    ...
                                    <?php
                                    $sqlfordistricts2 = $this->db->query("SELECT
 d.`DIV_ID`,d.`DIV_NAME`
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <?php $sqlforemp = $this->db->query("SELECT d.`SchoolLevelId`,d.
`SchoolLevel`
,IFNULL((SELECT SUM(ds.`tot`)
...
GROUP BY d.`SchoolLevelId`,d.`SchoolLevel`")->result(); ?>
                <script>
                    ...
                    $(function () {
                        Highcharts.setOptions({
                            colors: ['#DC143C', '#4B0082', '#008B45', '#C266E0',
 '#458B74', '#0AC92B', '#00E5EE', '#4A777A',
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <h3 align="center"></h3>
                <?php $level_std_sql = $this->db->query("SELECT s.`SchoolLevelId
`,s.`SchoolLevel`,SUM(s.`TotalStudents`) AS tot FROM `distwise_students` AS s
...
ORDER BY s.`SchoolLevelId` ASC")->result();
                ...
                <script>
                    ...
                    $(function () {
                        Highcharts.setOptions({
                            colors: ['#4DB8FF', '#8B1A1A', '#000000', '#EE7600',
 '#458B74', '#0AC92B', '#00E5EE', '#4A777A',
                                '#60AFFE', '#FFCC00', '#997A00', '#CCCC00', '#FF3300', '#FF704D', '#803826', '#99CC00',
                                '#666633', '#A3A385', '#993366', '#CE9DB6', '#993333', '#B7A3A3', '#335C33', '#C266E0',
                                '#B2B247', '#8E8E39', '#CCFF99', '#7A995C', '#4DB8FF', '#339933', '#996633', '#C2A385']
                                ...
                                series: [
...

                                    {
                                        ...
                                        data: [
                                            ...
                                            <?php
                                            $sqlfordisstds = $this->db->query("SELECT s.`SchoolLevelId`,s.`SchoolLevel`,s.`dis_id`,s.`dis_name`, SUM(s.`TotalStu
dents`) AS tot FROM `distwise_students` AS s
