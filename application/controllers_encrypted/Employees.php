...
class Employees extends MY_Controller
{
    ...
    public function insert_employee()
    {
        ...
        if ($_FILES['file_picture']['name'] != '') {
            ...
            if (move_uploaded_file($_FILES['file_picture']['tmp_name'], $data_up
load)) {
      ...
      //  echo $this->db->last_query();exit;
        $this->session->set_flashdata('msg', '<div class="alert alert-success al
ert-dismissable">
...
ert-dismissable">
   ...
   <span>Record Updated Successfully..!</span>
    ...
    public function employee_detail()
    {
        ...
        $this->header();
        $data['empDetail'] = $this->Main_model->single_row('employee_profile', $
where, 's');
    ...
    {
       $data['record'] = $this->General->select_where('employee_profile',array('
EMP_ID'=>$id));
        $this->header();
