  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
		...
		<div id="printArea" class="panel panel-info">
			...
			<div class="panel panel-heading">Edit Tithe</div>
			...
			<?php
				...
				<div class="col-md-8 col-md-offset-2">
					<form method="POST" action="<?php echo base_url()?>tithe/updatetithe/<?php echo $id?>">
					<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="onames" id="onames" value="<?php echo $row->OTHER_NAMES; ?>">
							...
							<hr>
							<input type="submit" name="add" value="Update Tithe" class="btn bg-navy pull-right">
