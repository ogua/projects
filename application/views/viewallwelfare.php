  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
		...
		<div id="printArea" class="panel panel-info">
			<div class="panel panel-heading">All WELFARE INFORMATION</div>
			<div class="panle panle-body">
			<div id="displaymsg"></div>
			 <div class="table-responsive">
				<table id="alltithe" class="table table-striped table-bordered">
					<thead>
						<tr>
							<th>#</th>
							<th>Card ID</th>
...
<!-- jQuery Script-->
	...
	<script>
		$('document').ready(function(){			
			var dataTable = $('#alltithe').DataTable({  
				   "processing":true,  
				   "serverSide":true,  
				   "order":[],  
				   "ajax":{  
						url:"<?php echo base_url() . 'welfare/fetch_user'; ?>",  
						type:"POST"  
				   },  
				   "columnDefs":[  
						{  
			...
			$(document).on("click",".delmember", function(e){
				...
				if(confirm("Are You Sure You Want To Delete This Information")){
					$.ajax({
						url: '<?php echo base_url() ?>welfare/delwelfare/'+cid,
						data: {cid: cid},
