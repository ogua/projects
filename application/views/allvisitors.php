  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
		...
		<div id="printArea" class="panel panel-info">
			<div class="panel panel-heading">All Visitors Of Ncwc</div>
			...
			<div id="displaymsg"></div>
			 <div class="table-responsive">
				<table id="members" class="table table-striped table-bordered">
					...
					<tbody>
				<?php
				 foreach($allvisitors->result_array() as $row){
					 ?>
					 <tr>
						<td><?php
							if(!empty($row['Image'])){							
						...
						<td><?php echo $row['curchrch']; ?></td>
						<td><?php echo $row['invited']; ?></td>
						<td><?php echo $row['phone']; ?></td>
						<td><?php
							echo '<a class="btn btn-info" href="'.base_url().'members/editvisitor/'.$row['id'].'">
				...
				<hr>
					<a href="<?php echo base_url();?>members/pdfallvisitors" id="pdf" class="btn btn-success">Generate Report</a>
			 </div>
		...
		$('document').ready(function(){			
			...
			$(document).on("click",".delmember", function(e){
				...
				if(confirm("Are You Sure You Want To Delete This Information")){
					$.ajax({
						url: '<?php echo base_url() ?>members/delvisitor/'+cid,
						success: function(data){
							alert(data);
							//window.location.href="<?php echo base_url() ?>members/";
							window.location.href=baseurl+"members/allvisitors"
						}						
					});
				}
			})
