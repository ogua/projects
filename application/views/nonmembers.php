		...
		<div id="printArea" class="panel panel-info">
			...
			<div id="displaymsg"></div>
			 <div class="table-responsive">
				...
				<hr>
				<a href="<?php echo base_url();?>members/pdfallnonmembers" id="pdf" class="btn btn-success">Generate Report</a>
...
<!-- jQuery Script-->
	...
	<script>
		$('document').ready(function(){			
				...
				if(confirm("Are You Sure You Want To Update This Information")){
					$.ajax({
						...
						success: function(data){
							...
							//alert(data);
							 //window.location.href="<?php echo base_url() ?>members/nonmembers";
							//dataTable.ajax.reload();
						}						
					});
				}
			...
			$(document).on("change","#group_status", function(e){
				e.preventDefault();
				var cid = $(this).data("cid");
				var statu = $(this).val();
				//alert(cid + statu);
				...
				if(confirm("Are You Sure You Want To Update This Information")){
					$.ajax({
						url: '<?php echo base_url() ?>members/groupupdate',
						method: 'POST',
						data: {cid: cid, statu: statu},
						success: function(data){
							alert("Status Updated Successfully");
