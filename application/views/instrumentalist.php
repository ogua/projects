  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
		...
		<div id="printArea" class="panel panel-info">
			<div class="panel panel-heading">All Choristers Of Ncwc</div>
			...
			<div id="displaymsg"></div>
			 <div class="table-responsive">
				...
				<hr>
				<a href="#" id="print" class="btn btn-success">Print Page</a>
				<a href="<?php echo base_url();?>members/pddindtrumentalist" id="pdf" class="btn btn-success">Generate Report</a>
			 </div>
			 </div>
			</div>
		</div>
