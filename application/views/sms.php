  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
		...
		<div id="printArea" class="panel panel-info">
			<div class="panel panel-heading">Send SMS</div>
			<div class="panle panle-body">
				...
				?>
					<?php echo form_open('sms/sendmessage');?>
					  <!-- /.col -->
					  <div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="row" id="changeit">
								
							</div>							
							<!--<div class="row" id="changet">
								<div class="col-md-10">
									<div class="form-group">
											<select name="phone" class="form-control" required>		
												<option value="">Select Phone Numbers</option>
								...
								<div class="col-md-2">
									<a href="#" id="change" class="btn btn-success">Type Contact</a>
								</div>
							</div>-->
						...
						<div class="box-footer">
						  <div class="pull-right">
							<button type="submit" class="send btn btn-primary"><i class="fa fa-envelope-o"></i> Send</button>
						  </div>
						</div>
						<!-- /.box-footer -->
					  </div>
