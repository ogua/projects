    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="<?=base_url();?>reports/purchaseReport" method="post"
                      class="form-horizontal form-bordered form-validate" id="frm1">
                ...
                <div id="printableArea">
                    <link href="<?= base_url(); ?>assets/css/sales_report.css" rel="stylesheet" type="text/css">
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <header class="clearfix">
                                <div id="logo">
                                    <img src="http://localhost/easy_inventory/img/logo.png">
                                </div>
                                <div id="company">
                                ...
                                foreach ($purchases as $rows): ?>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td align=""><?= $rows->purchase_date; ?></td>
