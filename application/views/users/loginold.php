...
<body class="hold-transition login-page" style="background-image: url('<?=base_url()?>uploads/loginbb.jpg') !important; margin-bottom: 0px !important;">

<div class="login-box" style="background: white; opacity: 0.6">
  <div class="login-logo" style="color: white;">
    <a href="#"><b>DENNIS</b> FILE TRACKING SYSTEM</a>
  </div>
