<header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>NC</b>WC</span>
         ...
         <!-- <li class="dropdown notifications-menu">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">NCWC</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                 NCWC
                  <small>founded in March 2003</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" id="ncwcprile" class="btn btn-default btn-flat">Profile</a>
                </div>
