...
<head>
    ...
    <title>MMA RMS | Dashboard</title>
     <!--<link rel="icon" type="image/jpg" href="<?=base_url();?>uploads/images/favicon.ico">-->
...
<div class="wrapper">
    ...
    <header class="main-header"  style="height:63px;">
        <!-- Logo -->
        <a href="<?=base_url()?>index.php/dashboard" class="logo" style="height:63px;">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>M</b>RMS</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>MMA</b> <b>RMS</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?=base_url()?><?=$this->session->userdata('emp_pic');?>" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?=$this->session->userdata('employee');?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?=base_url()?><?=$this->session->userdata('emp_pic');?>" class="img-circle" alt="User Image">
                            ...
                            <li style="text-transform:capitalize;">Welcome: <font color="#0296ca"><?php echo $this->session->userdata('employee');?></font></li>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <?php foreach ($parent_nav as $prow): ?>
                    ...
                    <a href="<?php if ($prow->MENU_URL == "#") {
                        ...
                        <i class="<?php echo $prow->MENU_ICON; ?>"></i>
