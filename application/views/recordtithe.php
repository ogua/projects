  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
		...
		<div id="printArea" class="panel panel-info">
			<div class="panel panel-heading">Record Tithe</div>
			...
			<?php
				...
				<div class="col-md-8 col-md-offset-2">
					<form method="POST" action="<?php echo base_url()?>tithe/addtithe">
							...
							<div class="form-group">
								<label class="control-label">Tithe ID / Page ID</label>	
							...
							<hr>
							<input type="submit" name="add" value="Add New Tithe" class="btn bg-navy pull-right">
