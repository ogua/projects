...
<div class="box box-primary">
    <div class="box-header">
        <h2 class='box-title'>Created Files</h2>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
...
<td><span class="blue"><?= $issueds[$i]['reference_no']; ?></span></td>
                            ...
                            <td><span class="blue"><?= $issueds[$i]['designation']; ?></span></td><?php
                            ...
                            <td><?= $issueds[$i]['empname']; ?></td>
                             <td>
                                ...
                                $sqlimage = $this->db->query("SELECT * FROM `attachment` WHERE `idissue` = '$idissue'")->row_array();
                                if (!empty($sqlimage)) {
                                    echo '<ul class="enlarge" style="list-style-type: none;
margin-left: 0;">';
                                 
                                        $ext = pathinfo($issueds[$i]['scan_image'], PATHINFO_EXTENSION); ?>
...
float: left;">
                                                ...
                                                <a href="<?=base_url().$issueds[$i]['scan_image'];?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Download</a>
