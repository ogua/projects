    ...
    <div class="box-body">
            ...
            <table id="example1" class="table table-responsive table-bordered table-hover">
                ...
                if (!empty($issueds)) {
                    for ($i = 0; $i < count($issueds); $i++) {
                        ?>
                        <tr class="tr1">
                            <td><input type="checkbox" class="chk" value="<?= $issueds[$i]['main_id']; ?>"></td>
                            <td><span
                                    class="blue"><?= date("d-m-Y H:i:s", strtotime($issueds[$i]['date_received'])); ?></span>
                            </td>
                            <td>
                                <span
                                    class="blue"><?= date("d-m-Y H:i:s", strtotime($issueds[$i]['date_on_letter'])); ?></span>
                            </td>
        ...
        <div class="box-footer">
            <a href="#" class="btn btn-success"
               onclick="showAjaxModal('<?php echo base_url(); ?>Letter/getSelectedValues');">
                <i class="entypo-credit-card"></i>
                Forward Selected Letters
            </a>
        </div>
