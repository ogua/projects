        ...
        <div class="row">
           <?php foreach ($issueds as $issued) { ?>
            <div class="col-md-3 col-sm-6 col-xs-12">
               <?php $color = ''; if($issued['issue_files'] > 0 ){?>
                <a href="<?=base_url()?>index.php/Letter/issued_detail/<?=$issued['idfiletype']?>/<?=$date;?>/<?=$todate;?>">
                    <?php $color = '#efeded'; } ?>
                <div class="info-box" style="background: <?=$color?>;">
                    <span class="info-box-icon bg-aqua"><i class="fa fa-envelope-o"></i></span>

                    <div class="info-box-content">
                        <span class="info-box-text"><?=$issued['filetype'];?></span>
                        <span class="info-box-number"><?=$issued['issue_files'];?></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
