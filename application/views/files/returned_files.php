            ...
            <table id="example1" width="100%" class="table table-responsive">
                ...
                if (!empty($issueds)) {
                    for ($i = 0; $i < count($issueds); $i++) {
                        ...
                        <tr class="tr1">
                            <td><span
                                    class="blue"><?= date("d-m-Y", strtotime($issueds[$i]['date_of_sending'])); ?></span>
                            </td>
...
float: left;">
                            ...
                            <td>
                                   <a href="#"
                                   onclick="showAjaxModal('<?= base_url() ?>index.php/Letter/viewReturnedLetter/<?= $issueds[$i]['main_id'] ?>')"
                                   class="btn btn-info">View </a> |
                                <a href="#track<?= $issueds[$i]['main_id']; ?>"
                                   onclick="getReturned(<?= $issueds[$i]['main_id']; ?>)" class="imran btn btn-success"
                                   data-toggle="modal">
                                    Track </a>
...
<div class="modal fade" id="modal_ajax">
    <div class="modal-dialog" >
        <div class="modal-content" style="width: 700px !important; height: 700px !important;">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Details of Returned Letters</h4>
            </div>
