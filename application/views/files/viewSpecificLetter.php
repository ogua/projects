    ...
    <div class="col-lg-12">
        ...
        ?>
            ...
            <tr>
                ...
                <td><?= $issueds[$i]['reference_no']; ?>
                </td>

                <th>Date of Letter</th>
                <td><?= $issueds[$i]['date_on_letter']; ?></td>
            </tr>
            <tr>
            ...
            ?>
            <th>Created By</th>
            <td><?php echo $issueds[$i]['empname']; ?></td>
                      </tr>
            <tr>
            <th>Created Date</th>
            <td><span
                    class="blue"><?= date("d-m-Y", strtotime($issueds[$i]['date_received'])); ?></span>
            </td>
            </tr>
