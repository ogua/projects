...
<div class="box box-default">
    ...
    <div class="box-body">
        ...
        <fieldset class="signup">
            <legend>Issued <?= $rowfiletype['filetype']; ?> of <?=$this->department ?> Section</legend>
            ...
            <table id="example1" width="100%" class="table table-responsive">
                ...
                for ($i = 0; $i < count($iDetails); $i++) {
                    ...
                    <tr class="tr1">
                        ...
                        <td><a href="<?=base_url()?>index.php/Letter/getTrackOfIssuedFiles/<?php echo $iDetails[$i]['idissue']; ?>">
                                Track </a></td>
