                ...
                <?php error_reporting(0)?>
                                            ...
                                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
                                                ...
                                                <p class="text-muted rmb" style="display:block;">
                                                	Thank you for installing "Kandi User Management System". Best wishes for the next
                                    ...
                                    <div class="panel-footer text-right" style="background-color: #fff;">
                                        <div class="box-inline">
                                            ...
                                            <button type="button" class="finish btn btn-success submitter" disabled>Install Kandi UMS</button>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <center> 2015 &copy; All Rights Reserved @ <a href="about:blank">Kandi UMS </a></center>
                    </div>
