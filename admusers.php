  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
			...
			<i class="glyphicon glyphicon-user"></i>
              <h3 class="box-title">User Registration <span><small>> View Users</small></span></h3>
	...
	<div id="displayerrormsghere">
			...
			<div class="table-responsive" style="background-color:#abc;">
				...
				<button class="btn btn-default">Total Usera &nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button>	
		...
		';
				...
				<td>'.$row['email'].'</td>
				<td>'.$row['phone'].'</td>
				<td><a href="admindelet.php?del='.$row['id'].'" class="btn btn-danger"><span class="fa fa-trash"></span></a></td>
				</tr>
						';
							$x++;
				}
