			...
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					<ul class="list-inline">
						...
						<li><a href="generatereport.php" class="btn btn-info" style="width:100%;">Generate Report</a></li>
						<li></li>
					</ul>
...
<?php
			...
			//get rows query
			$sql = "SELECT * FROM `booking`  WHERE `Hostelid` = '".$_SESSION['id']."' ";
...
tinymce.init({
	...
	$(document).ready(function(){	
		...
		$.ajax({
			url: 'action.php',
			type: 'POST',
			data: {getnerate6: 1, dfrom: dfrom, dto: dto},
			success: function(data){
				$("#shoehere").html(data);
			}
		});
