				...
				<div class="panel panel-body">
					...
					<div id="alert">
					 <div class="alert alert-danger alert-dismissible">
						...
						Once Voting Start, You cant start voting again, Make sure you finish with the voting before logging out or switching from this page
					  </div>
					 </div>
					 </div>
				</div>
			...
			$("#startvoting").click(function(e){
				...
				if(confirm("Are you sure you want to start Voting")){
					...
					$.ajax({
						url: 'action.php',
						type: 'POST',
						data: {StartVote: 1, volterid: volterid},
						success: function(data){
