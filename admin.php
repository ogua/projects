	   ...
	   <form method="post" action="" >
        ...
        <div class="row" style="margin-top:50px;margin-left:20px;margin-right:20px;margin-bottom:30px;">
				<div class="col-sm-4" style="background-color: #42327a;border-color: #42327a;height:400px;">
				           <ul id="myTab" style="list-style:none;margin-top:120px;">
                                      <li><a data-toggle="tab" href="#sectionA"><button style="width:200px;"type="button" class="btn btn-sm btn-success">Add User</button></a></li>
                                       <li><a data-toggle="tab" href="#sectionB"><button style="width:200px;margin-top:10px;"type="button" class="btn btn-sm btn-success">View Users Information</button></a></li>
									   <li><a data-toggle="tab" href="#sectionC"><button style="width:200px;margin-top:10px;"type="button" class="btn btn-sm btn-success">Reset Password</button></a></li>
						             <li><a data-toggle="tab" href="#sectionD"><button style="width:200px;margin-top:10px;"type="button" class="btn btn-sm btn-success">Delete User</button></a></li>
									 <li><a data-toggle="tab" href="#sectionE"><button style="width:200px;margin-top:10px;"type="button" class="btn btn-sm btn-success">Generate Report</button></a></li>
                           </ul>                 
