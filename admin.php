<?php
					if(isset($_POST['send'])){
						include_once("db.php");						
						$sql="SELECT * FROM `Admin` WHERE  `username` = '".$_POST['nameE']."' AND `password` = '".$_POST['pwd']."'";
...
<!-- comedy-w3l-agileits -->
	...
	<div class="col-md-10 col-md-offset-2" style="margin-bottom:10px;">
		<a href="index.php" class="btn btn-success">&larr; Back to Homepage</a>
		</div>
		<div class="clearfix"></div>
		<div class="row">
		<div class="col-md-2">
