										  ...
										  <div id="getProct">
														...
														<div class="panel-heading" id="displayMessage"></div>
															<h3 style="color:white;">Patient Details</h3>
																	...
																	<div class="form-group">
																		<label style="color:white;"><i class="glyphicon glyphicon-user"></i>&nbsp;User ID</label>
																		<input  style=""type="text" value="<?php echo strtolower($row['userId']); ?>"class="form-control" id="puid" disabled>
																	</div>
																	<div class="form-group">
																		...
																		<?php
																			...
																			$addrf = ucwords($addrl);
																		?>
																		<input  style=""type="text" value="<?php echo $addrf; ?>"class="form-control" id="padress" >
																	</div>
																	<div class="form-group">
																		<label style="color:white;"><i class="glyphicon glyphicon-phone-alt"></i>&nbsp;Contact</label>
																		<input  style=""type="text" value="<?php echo $row['contactno']; ?>"class="form-control" id="pcont"></span></b></li><br>
																	</div>
																	<div class="form-group">
																		<label style="color:white;"><i class="glyphicon glyphicon-globe"></i>&nbsp;Email</label>
																		<input  style=""type="email" value="<?php echo strtolower($row['email']); ?>"class="form-control" id="pemail"></span></b></li><br>	
																	</div>
																		<input  style="border-top-right-radius:25px;border-top-left-radius:25px;" type="submit" value="Update"class="btn btn-info btn-sm pull-right" id="updatep">																																		
