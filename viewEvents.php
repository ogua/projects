    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">All Event</div>
					...
					$result = mysqli_num_rows($query);
						if($result > 0){
							while($row = mysqli_fetch_assoc($query)){
								echo'
								<a href="eventpageview.php?evntid='.$row['Eventid'].'"><div class="row">
									<div class="col-md-12">
									  <div class="info-box">
										<span class="info-box-icon"><img src="images/'.$row['image'].'"></span>

										<div class="info-box-content">
											<p class="text-danger"><i class="glyphicon glyphicon-pencil"></i>&nbsp;'.$row['Title'].'</p>
											<p class=""><i class="glyphicon glyphicon-map-marker"></i>&nbsp;'.$row['Location'].'</p>
											<p class=""><i class="glyphicon glyphicon-time"></i>&nbsp;'.$row['datefrm'].'</p>
											<p><i class="glyphicon glyphicon-earphone"></i>&nbsp; '.$row['Contact'].'</p>
										</div>
									  </div>
									</div>
								</div></a>
