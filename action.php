<?php
	...
	if(isset($_POST['BookinReport'])){
		//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `event` WHERE `dates` BETWEEN '".$_POST['tfrm']."' AND '".$_POST['tto']."'");
			//number of rows
	...
	if(isset($_POST['BookinReportout'])){
		//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `event` WHERE `dates` BETWEEN '".$_POST['tfrm']."' AND '".$_POST['tto']."' AND datediff(`dates`,CURRENT_DATE) < 0");
			//number of rows
			$rowCount = mysqli_num_rows($query);
			if($rowCount > 0){ 
			echo'
	...
	if(isset($_POST['BookinReportUP'])){
		//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `event` WHERE `dates` BETWEEN '".$_POST['tfrm']."' AND '".$_POST['tto']."' AND datediff(`dates`,CURRENT_DATE) > -1");
			//number of rows
			$rowCount = mysqli_num_rows($query);
			if($rowCount > 0){ 
			echo'
