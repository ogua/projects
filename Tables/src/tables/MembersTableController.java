...
public class MembersTableController implements Initializable {
   ...
   private ObservableList<members> data;
    ...
    rst = st.executeQuery();
    while(rst.next()){
      data.add(new members(rst.getInt(1),rst.getString(2),rst.getString(3),rst.getString(4),rst.getString(5),rst.getString(6),rst.getString(7),rst.getString(8),rst.getString(9),rst.getString(10),rst.getString(11),rst.getString(12),rst.getString(13),rst.getString(14),rst.getString(15),rst.getString(16),rst.getString(17),rst.getString(18),rst.getString(19)));
