      ...
      <div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-3" style="border:1px solid gren;">
				<img src="images/<?php echo $row['images']; ?>" alt="" width="200" height="400">
			</div>
			<div class="col-md-9" style="border:1px solid gren;">
				<div class="grid blog-desc">
								<a href="Artistreg.php" class="btn btn-info btn-sm">&larr;</a>
								<h4>
								...
								<h4 class="text-danger" style="margin-left:-40px;">Joined <?php echo $row['dates']; ?>,&nbsp;&nbsp;
