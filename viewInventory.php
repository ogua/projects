    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Inventory :: Stock &nbsp;<span><img src="images/prescri.jpg" class="img-circle" height="50" width="50"></span></div>
			...
			<div class="table-responsive">
				...
				<button class="btn btn-default">Total Products&nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button>
		...
		';
				...
				<td>'.$row['price'].'</td>
				<td>'.$row['Quantity'].'</td>
				<td><a href="upadetstock.php?id='.$row['id'].'" class="btn btn-info"><span class="fa fa-edit"></span></a></td>
				</tr>
						';
							$x++;
				}
