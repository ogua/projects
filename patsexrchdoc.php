    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:#3f51b5;">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="patient.php">Menu</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse" style="background-color:#303F9F;">
          <ul class="nav navbar-nav">
				 ...
				 <li class="active"><a href="patsexrchdoc.php"><i class="glyphicon glyphicon-search"></i>&nbsp;Search Doctor</a></li>														
															...
															<div class="col-md-12">
																	<h3>Search Doctor</h3>																 
																		<div class="form-group">
																				<select  style="" name="searcat" id="searcat" class="form-control">
																					<option value="">Search By</option>
																					<option value="name">Doctors Name</option>
																					<option value="category">Type</option>                                																 
																				</select>
																		</div>
																		<div class="form-group">
																			<input  style="" type="text" id="sertext" class="form-control" placeholder="Type To Search">
																		</div>
																		<input style="background-color:#1f272a;border:#1f272a"type="submit" id="serpat" value="Search" class="btn btn-info btn-ms pull-right">
