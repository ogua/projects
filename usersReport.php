...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			<i class="glyphicon glyphicon-user"></i>
              <h3 class="box-title">Generate Report<span><small> &nbsp; > Users</small></span></h3>
	...
	<div id="displayerrormsgher">
			...
			<div class="box-body">
			<h2>Generate Report for Users</h2>
				<form method="POST" action="generatereportuer.php" id="genfrm">
