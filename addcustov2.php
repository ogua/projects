    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">View All Customers</div>
				<div class="panel panel-body">
					 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `customers`");
		...
		';
				...
				<td>'.$row['email'].'</td>
				<td>'.$row['dates'].'</td>
				<td><a href="viewcustom2.php?id='.$row['id'].'" class="btn btn-info"><span class="fa fa-eye"></span></a></td>
				<td><a href="#" id="delcustomer" cid="'.$row['id'].'" class="delcustomer btn btn-danger"><span class="fa fa-trash"></span></a></td>
				</tr>
						';
							$x++;
				}
