<?php
					if(isset($_POST['send'])){
						include_once("db.php");
						$hash = password_hash($_POST['edate'],PASSWORD_DEFAULT);
						if(!password_verify($_POST['etyme'],$hash)){
							echo '
								<div class="alert alert-danger"> <a href="#" class="close" data-dismiss="alert" arialabel="close">&times;</a><strong>
									Failed to register user
								</strong></div>
							';
						}else if(strlen($_POST['nmeE']) < 10 || strlen($_POST['nmeE']) > 10){
						...
						$sql = "INSERT INTO `bookusers`(`username`, `password`, `phone`) 
						VALUES ('".$_POST['nameE']."','".$_POST['etyme']."','".$_POST['nmeE']."')";
						$query = mysqli_query($conn,$sql);
						if($query){
							echo '
								<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert" arialabel="close">&times;</a><strong>
									Username Registered Successfully <a href="login2.php" class="btn btn-success">Click to Login</a>
								</strong></div>
							';
						}else{
							echo '
		...
		<div class="col-md-2">
			...
			<div class="col-md-6 well">
				...
				<form method="POST" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="col-md-12">
							<div class="col-md-6">
								...
								<input type="password" class="form-control" name="edate" id="edate" required>
							</div>
							<div class="col-md-6">
							<label>Confirm</label>
							<input type="password" class="form-control" name="etyme" id="etyme" required>
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input type="submit" name="send" value="Create Event" class="btn btn-success">
					</div>
