    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:#3f51b5;">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse" style="background-color:#303F9F;">
         ...
         <li class="active"><a href="doctor.php"><i class="glyphicon glyphicon-user"></i>&nbsp;My Details</a></li>
    ...
    <div class="container-fluid back2" style="margin-top:30px;">				
										  <div id="getProct">
														...
														<div class="panel-heading" id="displayMessage"></div>
															...
															<div class="col-md-12">
															<h3 style="color:white;">Your Details</h3>
																	...
																	<div class="form-group">
																		<label style="color:white;"><i class="glyphicon glyphicon-user"></i>&nbsp;Doc ID</label>
