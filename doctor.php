<?php 
	...
	if(isset($_POST['send'])){
		$sql2 = " UPDATE `patients` SET `Ref` = '".$_POST['PatREf']."', `PatientID` =  '".$_POST['preid']."' , 
...
<body class="back">
    <h1 class="text-center" style="color:#d8bc35;">Doctors Department</h1>
	 ...
	 <form method="post" action="" >	   
		...
		<fieldset>
		   <div class="col-sm-6">
			<legend style="color:#d8bc35;"><b>Personal Details</b></legend>
			...
			<div class="form-group">
				<input class="form-control" type="number" value="<?php echo $row['Age']; ?>" name="prefAge" id="prefAge" placeholder="Patient Age" required />
						...
						<label style="color:#d8bc35;">Programme</label>
			<!--<div class="form-group">
				<input class="form-control" type="text" value="<?php echo $row['course']; ?>" name="prefcou" id="prefcou" placeholder="Patient Course" required />
			</div>--->
			...
			<br>
			<legend style="color:#d8bc35;"><b>Lab Results Information</b></legend>
		   ...
		   <tbody>
			...
			<div class="col-sm-6">
						<legend><b>Personal Record</b></legend>
		...
		<a href="previous.php?id=<?php echo $row['Ref'];?>"><button style="margin-bottom:20px;background-color: #42327a;border-color: #42327a;"class="btn btn-info pull-right" > View Previous Information</button></a>
</body>
</html>