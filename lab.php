...
<body class="back">
    <h1 class="text-center" style="color: #42327a;background-color:#ccc;border:1px solid #fff;padding:20px;">Laborary</h1>
	...
	<div class="row" style="margin:20px;">
			...
			<div class="col-md-12">
				<div class="col-md-4">
					<Label style="color:#d8bc35;"><b>REFERENCE </b></label>
					<hr>
				</div>
				<div class="col-md-8">
