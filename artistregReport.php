  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
		 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `airtest`");
			...
			<div class="table-responsive">
				...
				<button class="btn btn-default">Total Artist&nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button>
		...
		$('document').ready(function(){
			$("#send").click(function(){
				...
				$.ajax({
					url: 'action.php',
					type: 'POST',
					data: {AirtestReport: 1, tfrm: tfrm, tto: tto},
