    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Add Volter</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<form method="post" action="" id="addvolter" enctype="multipart/form-data">
								...
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Add Volter">
								</div>
							</form>
						</div>
					</div>
				...
				$.ajax({
					...
					success: function(data){
						if(data.match("sucess")){
							alert("Volter Added Successfully!");
							window.location.href="volters.php"
