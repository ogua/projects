...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			<i class="glyphicon glyphicon-user"></i>
              <h3 class="box-title">Generate Report<span><small> &nbsp; > Transactions</small></span></h3>
	...
	<div id="displayerrormsgher">
			...
			<div class="box-body">
			<h2>Report Generated for Individual Transactions</h2>
				<form method="POST" action="generatereportIndivi.php" id="genfrm">
					<div class="form-group">
						<div class="col-md-6">
							<input type="text" name="nameofin" class="form-control" placeholder="Enter Name to Search" required>
						</div>
					</div>
