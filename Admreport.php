  ...
  <body class="back">
    ...
    <div class="container-fluid backs" style="margin-top:50px;">	
										  <div id="getProct">
														...
														<div class="col-md-12">
															<h3 style="color:white;">Generate Report For all Doctors</h3>
																<form method="post" action="admindocsreport.php">
																	<ul class="list-inline">
																		<li>
																			<div class="form-group">
																			<label style="color:white;">FROM</label>
																				<input type="date" name="frm" class="form-control" required>
																			</div>
																		</li>
																		<li>
																			<div class="form-group">
															...
															<div class="col-md-12">
															<h3 style="color:white;">Generate Report For all Patients</h3>
																<form method="post" action="adminallpatients.php">
																	<ul class="list-inline">
																		<li>
																			<div class="form-group">
																			<label style="color:white;">FROM</label>
															...
															<hr style="border:2px solid #ccc;">
															<div class="col-md-12">
															<h3 style="color:white;">Generate Report For all Appointments</h3>
																<form method="post" action="adminallapprepor.php">
																	<ul class="list-inline">
																		<li>
																			<div class="form-group">
																			<label style="color:white;">FROM</label>
