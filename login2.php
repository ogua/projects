<?php
					if(isset($_POST['send'])){
						include_once("db.php");						
						$sql="SELECT * FROM `bookusers` WHERE `username` = '".$_POST['nameE']."' AND `password` = '".$_POST['pwd']."'";
						$query = mysqli_query($conn,$sql);
						$result = mysqli_num_rows($query);
						if($result == 1){
							$row = mysqli_fetch_array($query);
							session_start();
							 $_SESSION['bookuserid'] = $row['id'];
							 $_SESSION['bookusername'] = $row['username'];
	...
	<div class="wthree-comedy">
		...
		<div class="col-md-2">
			...
			<div class="col-md-8 well">
				<h3 class="text-center">Login to book Event</h3>
				...
				<form method="POST" action="">
					...
					<div class="form-group">
						<a href="creatAccnt.php">Create Account</a>
					</div>
