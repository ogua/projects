			...
			<div class="col-md-12">
				<div class="panel panel-info">
					...
					<div class="panel panel-body" id="shoehere">
							 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `hostels`  WHERE `Approval` = '1'");
			$row = mysqli_fetch_assoc($sqlAll);
			$allrow = $row['numofrows'];
			//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `hostels`  WHERE `Approval` = '1'");
			//number of rows
