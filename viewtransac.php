    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">View Transaction &nbsp;<span><img src="images/prescri.jpg" class="img-circle" height="50" width="50"></span></div>
				<div class="panel panel-body">
					 <div class="col-md-6 col-md-offset-3">
<input type="text" style="border-top-right-radius:25px;border-top-left-radius:25px;" id="tsc" name="tsc" class="form-control" placeholder="SEARCH BY BILL ID"/>
					 </div>
...
<script>
		$('document').ready(function(){
			$("#tsc").keyup(function(){
				var transac = $(this).val();
				//alert(transac);
				if(transac !==""){
					$.ajax({
						url: "./AdminCode/allTransactionLive.php",
						method: "post",
						data: {transac: transac},
						success: function(response){
							$("#getTran").html(response);
						}
					});
				}else{
					$.ajax({
						url: "./AdminCode/allTransaction.php",
						method: "post",
						success: function(response){
							$("#getTran").html(response);
						}
