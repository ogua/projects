      ...
      <div class="container-fluid">
		 <?php
			...
			<div class="table-responsive">
				...
				<button class="btn btn-default">Total Artist&nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button><input type="text" id="searchartist" class="form-control" placeholder="Search Artist .. Type name of Artist">
				<br>	
				<div id="showAirtest">
...
<script>
		$('document').ready(function(){
			...
			$(document).on("click",".delecthostel",function(e){
				e.preventDefault();
				//alert("gooooooooooooooooooo");
				var cid = $(this).attr("cid");
				//alert(cid);
				$.ajax({
						url: 'action.php',
						type: 'post',
						data: {delArtist: 1, cid: cid},
						success: function(data){
							if(data.match("success")){
								alert("Artist Details Deleted Successfully!");
								window.location.href="Artistreg.php";
							}else{
								alert(data);
							}
						}
