...
<!-- comedy-w3l-agileits -->
	<div class="wthree-comedy">
		...
		<div class="col-md-2 well">
			...
			<li style="margin-bottom:10px;"><a href="#" class="btn btn-success" style="width:120px;">View Booking</a></li>
			...
			<div class="col-md-8 well">
				<?php
					session_start();
					     include_once('db.php');
						 $sqli6 = "SELECT * FROM `booking` WHERE `Userid` = '".$_SESSION['id']."'";
						 ...
						 if($result6){
					         ...
					         <table class="table table-striped"  border="1" >
						         <thead style="background-color: #d9534f;">
								     <tr>
									     <th style="font-weight:bold;font-size:20px;">Full Name</th>
										 <th style="font-weight:bold;font-size:20px;">Phone Number</th>
										 <th style="font-weight:bold;font-size:20px;">Event Price</th>
										 <th style="font-weight:bold;font-size:20px;">quantity Booked</th>
										 ...
										 <th style="font-weight:bold;font-size:20px;">RefID</th>
									 </tr>
								 </thead>
								 <tbody>';
							 while($row6 = mysqli_fetch_array($query6)){
								 echo'
								     <tr>
										 ...
										 <td style="font-weight:bold;font-size:15px;">'.$row6['Phone'].'</td>
