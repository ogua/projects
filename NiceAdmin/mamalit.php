			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            ONLINE ORDER || MAMALIT SPECIAL<small></small>
                        </h1>
                    </div>
                </div> 
                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
								...
								$countries = array("Rice and Stew", "Plain Rice and Stew", "Banku and Okro Stew","Fried Rice and Chicken", "Jollof rice");
...
if(isset($_POST['submit'])){
$sql = "INSERT INTO mamalit_special (title, name, phone, type_food, packaging, quantity, message)
VALUES ('".$_POST["title"]."','".$_POST["name"]."','".$_POST["phone"]."','".$_POST["type_food"]."','".$_POST["packaging"]."','".$_POST["quantity"]."','".$_POST["message"]."')";

if ($conn->query($sql) === TRUE) {
echo "<script type= 'text/javascript'>
alert('Order Submitted successfully');
window.location.href='payment.php?id=1';
</script>";
} else {
