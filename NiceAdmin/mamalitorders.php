        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-square-o"></i>Mamalit Special Orders</li>
            </ol>
          </div>
        </div>
...
$sql = "SELECT * FROM mamalit_special";
...
// Attempt select query execution
$sql = "SELECT * FROM mamalit_special WHERE status = '1' ";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo '
        <div class="card card-contact-list">
...
// Attempt select query execution
$sql = "SELECT * FROM mamalit_special WHERE status = '2' or status = '0' ";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo '
        <div class="card card-contact-list">
	...
	$("document").ready(function(){
		...
		$(document).on("change",".update", function(){
			...
			$.ajax({
				url: 'action.php',
				type: 'post',
				data: {Updatestatus: 1, cid: cid, stat: stat},
				success: function(data){
					if(data.match("success")){
						alert("Status Updated Successfully");
						window.location.href="mamalitorders.php";
					}else{
