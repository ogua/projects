			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            ONLINE ORDER || TANEE SPECIAL <small></small>
                        </h1>
                    </div>
                </div> 
                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
								...
								$countries = array("Tuo Zaafi with Ayoyo soup", "Waakye", "Kenkey and Fish", "Fufu and Soup", "Banku and Okro Stew", "Red Red Beans stew with fried plantains", "Ghana style Jollof rice", "Fufu and goat light soup");
...
if(isset($_POST['submit'])){
$sql = "INSERT INTO tanee (title, name, phone, type_food, packaging, quantity, message)
VALUES ('".$_POST["title"]."','".$_POST["name"]."','".$_POST["phone"]."','".$_POST["type_food"]."','".$_POST["packaging"]."','".$_POST["quantity"]."','".$_POST["message"]."')";

if ($conn->query($sql) === TRUE) {
echo "<script type= 'text/javascript'>
alert('Order Submitted successfully');
window.location.href='payment.php?id=3';
</script>";} else {
