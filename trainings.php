<?php
	...
	if(!empty($_SESSION['role'])){
		header("location: vtrainings.php");
	}
?>
<!DOCTYPE html>
<html>
    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Manage Training</div>
						...
						<div class="col-md-6">
							<form method="post" action="" id="adduser" enctype="multipart/form-data">
								<div class="form-group">
									...
									<textarea name="puroftr" rows="3" cols="3" class="form-control"></textarea>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="date" class="form-control" id="trstart" name="trstart" required>
								</div>
								<div class="form-group">
									<label>Training End</label>
									<input type="date" class="form-control" id="trend" name="trend" required>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Record Training">
								</div>
							</form>
						</div>
					</div>
				...
				$.ajax({
					...
					success: function(data){
						if(data.match("sucess")){
							alert("Farmers Training Recorded Successfully!");
