			...
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					<div class="row">
						...
						<div class="col-md-6">
							<form method="post" action="" id="changepass" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" id="pwrd" name="pwrd" required>
								</div>
								<div class="form-group">
									<label>Confirm Password</label>
									<input type="password" class="form-control" id="cpwrd" name="cpwrd" required>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Change Password">
								</div>
							</form>
						</div>
					</div>
...
<script>
		$('document').ready(function(){
			...
			$("#changepass").on("submi", function(e){
				e.preventDefault();
				$.ajax({
					url: 'passChange.php',
					type: 'POST',
					...
					success: function(data){
						if(data.match("sucess")){
							...
							window.location.href="passwordchnge.php"
						}else if(data.match("Failed")){
							alert("Failed! Email Or Password Does not Match");
						}else{
							alert(data);
						}						
					}
