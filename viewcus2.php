    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">All Customers</div>
		...
		';
				...
				<td>'.$row['gender'].'</td>
				<td>'.$row['voltersid'].'</td>
				<td><a href="addcuspolicy2.php?id='.$row['id'].'&name='.$row['name'].'" class="btn btn-info"><span class="fa fa-mouse-pointer"></span></a></td>
				</tr>
						';
							$x++;
				}
