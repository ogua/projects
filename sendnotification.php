    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Sent Notification</div>
				<div class="panel panel-body">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label for="users">Select Student ID To Send Message</label>
 ...
 <script>  
        ...
        db.once("value").then(function(snapshot){
         ...
         $("#btn-send").click(function(){
				...
				$("#spinner").show();
				if(to == ""){
					alert("Student ID Cant be Empty");
					$("#spinner").hide();
					return;
				}if(title == ""){
					alert("Notification Title Cant be Empty");
					$("#spinner").hide();
					return;
				}if(body == ""){
					alert("Notification Body Cant be Empty");
					$("#spinner").hide();
					return;
				}
                ...
                $.ajax({
                    ...
                    headers:{
                        Authorization: 'key=AIzaSyDsDW4CEKyXH3gG6RqbgGm9a3ZDWaZEdgw'
                    },
