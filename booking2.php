			...
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					<div class="row">
						...
						<div class="col-md-10">
							<div class="panel panel-info">
							<div class="panel panel-heading">Hostels Available</div>
							<div class="panel panel-body">
								 <div class="row">
									<?php
										include_once('db.php');
											...
											while($row = mysqli_fetch_array($query)){
												...
												<div class="col-md-3" style="border:1px solid #ccc;">
													...
													<div class="panel-heading">'.$row['name'].'</div>
															...
															<img class="thumbnail" src="images/'.$row['images'].'" height="200" width="150"/></a>
															</div>
															<div class="panel-footer">
																<a href="booking.php?id='.$row['id'].'" class="insercart btn btn-info btn-xs" style="margin-left:30px;">Book Now</a>
															</div>
													</div>
												</div>
												';
