  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
		 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `hostels`  WHERE `Approval` = '0'");
			$row = mysqli_fetch_assoc($sqlAll);
			$allrow = $row['numofrows'];
			//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `hostels`  WHERE `Approval` = '0'");
			//number of rows
		...
		';
				...
				';
					...
					echo'
				<td><a href="admindedit.php?id='.$row['id'].'" class="btn btn-success"><span class="fa fa-eye"></span></a></td>
				<td><a href="admindview.php?id='.$row['id'].'" class="btn btn-info"><span class="fa fa-eye"></span></a></td>
				<td><a href="#" id="delecthostel" cid="'.$row['id'].'" class="delecthostel btn btn-danger"><span class="fa fa-trash"></span></a></td>
				</tr>
						';
							$x++;
				}
			...
			echo'
				...
				echo'<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" 				arialabel="close">&times;</a><strong>No Hostels Pending for Approval Yet</strong></div>';
			}
            ?>
