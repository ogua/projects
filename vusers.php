      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `Admin`");
			...
			<div class="table-responsive">
				...
				<a href="admin.php" class="btn btn-default">Add User&nbsp;<i class="fa fa-plus"></i></a>
