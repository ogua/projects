        ...
        <div class="content-w3ls-inn px-lg-5">
            <div class="container py-md-5 py-3">
                <div class="px-lg-5">
                    ...
                    <p class="mt-5 pr-lg-5">We enjoy hearing from visitors and new friends. 
					It is quick and easy. Remember it's good to talk! 
					if you have any problem, suggestion, comment or just want to say hi,
					please dont hesitate to send them to us.
					Or you can email us at info@ncwc.com,
					We always do our best to respond to all the emails.</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="w3lSubject" id="w3lSubject" style="color:black;">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
