<?php
					     include_once('db.php');
						 $sqli6 = "SELECT * FROM `bill_t` WHERE `BillId` like '%".$_POST['transac']."%' ";
						...
						';
							 ...
							 echo'<div class="alert alert-danger text=-center"> <a href="#" class="close" data-dismiss="alert" arialabel="close">&times;</a><strong>Bill Id Dont Exit !</strong>';
						 }
					?>				