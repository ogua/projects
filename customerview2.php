...
background-image: no-repeat;
 ...
 <body class="back">
		...
		if($result > 0){
			...
			<div class="row">
			<div class="col-md-2">
					<a href="history.php" class="btn btn-info">&larr;Back</a>
			</div>
				<div class="col-md-4">
			...
			<a href="#" id="slidedo" class="btn btn-default">Add Alternative Pickup Person</a>
			<div id="disAkkls">
				<h3>Add Alternative Pickup</h3>
			<div class="form-group">
				<input type="text" id="fulNa" placeholder="Enter Full Name" class="form-control">
			</div>
			<div class="form-group">
				<input type="text" id="mob"placeholder="Enter Phone Number" class="form-control">
			</div>
			<div class="form-group">
				<input type="submit" id="addAl" class="btn btn-success pull-right" value="Add">
			</div>
			<div id="diplaAlg">
			</div>
			</div>
