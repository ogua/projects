  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
			...
			<i class="glyphicon glyphicon-user"></i>
              <h3 class="box-title">Customer Feedback <span><small> &nbsp; > View / Delete Feedbacks</small></span></h3>
	...
	<div id="displayerrormsghere">
			...
			<div class="box-body">
				 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `feedback`");
		...
		';
				...
				<td>'.$row['fullname'].'</td>
				<td>'.$row['feedback'].'</td>
				<td><a href="admindelet.php?delf='.$row['id'].'" class="btn btn-danger"><span class="fa fa-trash"></span></a></td>
				</tr>
						';
							$x++;
				}
