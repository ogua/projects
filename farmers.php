    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Add A Farmer</div>
				<div class="panel panel-body">
					<div class="row">
						...
						<div class="col-md-6">
							<form method="post" action="" id="addvolter" enctype="multipart/form-data">
								<div class="form-group">
									<label>Farmer's Image</label>
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" id="pwrd" value="1234" name="pwrd" required>
								</div>
								<div class="form-group">
									<label>Confirm Password</label>
									<input type="password" class="form-control" id="cpwrd" value="1234" name="cpwrd" required>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Add Farmer">
								</div>
							</form>
						</div>
					</div>
...
<script>
		$('document').ready(function(){
			...
			$("#addvolter").on("submit", function(e){
				e.preventDefault();
				$.ajax({
					url: 'addVolter.php',
					type: 'POST',
