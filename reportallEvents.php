    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Poll Results</div>
				<div class="panel panel-body">
					<form method="post" action="" id="viewResults">
									...
									<?php
										...
										if($query){
											...
											<select name="position" id="position" class="form-control" required>
												<option value="">Choose Candidate Position To view Results</option>';
								...
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Generate Report">
								</div>
							</form>
						<hr style="border:2px solid #ccc;">
						<div id="displayher"></div>
...
<script>
		$('document').ready(function(){
			...
			$("#viewResults").on("submit", function(e){
				e.preventDefault();
				var name = $("#position").val();
				$.ajax({
					url: 'action.php',
					type: 'POST',
					data: {viewreport: 1, name: name},
