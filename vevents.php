      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				...
				include_once("db.php");
					...
					<div class="col-md-2">Type of Event</div>
					<div class="col-md-2">Date</div>
					<div class="col-md-2">Time of Event</div>
					...
					<div class="col-md-2"><a href="viewit2.php?id='.$row['id'].'" class="btn btn-success">View</a></div>
				   </div>
