...
<html lang="en">
<head>
<title>E - Ticking Homepage</title>
<!-- for-mobile-apps -->
...
<!-- Latest-tv-series -->
	<div class="Latest-tv-series">
		<h4 class="latest-text w3_latest_text w3_home_popular">Book Event</h4>
		<div class="container">
			<?php
				include_once('db.php');
				...
				if($query){
					while($row = mysqli_fetch_array($query)){
						...
						<div class="col-md-2 w3l-movie-gride-agile">
								<a href="viewwEvent.php?id='.$row['id'].'" class="hvr-shutter-out-horizontal"><img src="images/'.$row['artwork'].'" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
										<h6><a href="viewwEvent.php?id='.$row['id'].'">'.$row['nameofevent'].'</a></h6>							
									</div>
	...
	<!-- general -->
	<div class="general">
		<h4 class="latest-text w3_latest_text">Featured Events</h4>
		<div class="container">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Top Events</a></li>
					<li role="presentation"><a href="#rating" id="rating-tab" role="tab" data-toggle="tab" aria-controls="rating" aria-expanded="true">Top Rating Events</a></li>
