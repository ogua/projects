      ...
      <div class="container-fluid">
		...
		<div class="row">
			...
			<form method="post" action="" id="uploadDrug" enctype="multipart/form-data">
					<input type="hidden" value="<?php echo $row2['id']; ?>" name="hostelid" >
					...
					<div class="form-group">
						...
						<input type="text" value="<?php echo $row2['manufacturername']; ?>"  name="nameofdrugMan" class="form-control" required>
					</div>					
					<div class="form-group">
						<label>Name Of Drug</label>
						<input type="text" value="<?php echo $row2['drugname']; ?>" name="nameofdrug" class="form-control" required>
					</div>	
					<div class="form-group">
						<label>Brand Of Drug</label>
						<input type="text" value="<?php echo $row2['brand']; ?>" name="brandofdrug" class="form-control" required>
					</div>	
					<div class="form-group">
						<label>Manufacturing Date</label>
						<input type="date" value="<?php echo $row2['manufacdate']; ?>" name="manuacdate" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Expiring Date</label>
						<input type="date" value="<?php echo $row2['Expdate']; ?>" name="expiredate" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Manufacturer Number</label>
						<input type="text" value="<?php echo $row2['manNumber']; ?>" name="manfbum" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Company Distributors</label>
						<input type="text" value="<?php echo $row2['Distributor']; ?>" name="distrib" class="form-control" required>
					</div>
					<div class="form-group">
						<input type="submit" value="Update Information" name="send" class="btn btn-success" >
					</div>
			</form>
			</div>
		</div>
