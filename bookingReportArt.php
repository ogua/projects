...
<head>
  ...
  <title>:: Artistes Booking Information</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="images/<?php echo $row['images']; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['name']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="images/<?php echo $row['images']; ?>" class="img-circle" alt="User Image">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
		 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `booking`  WHERE `id` = '".$_SESSION['id']."'");
			$row = mysqli_fetch_assoc($sqlAll);
			$allrow = $row['numofrows'];
			//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `booking`  WHERE `id` = '".$_SESSION['id']."' ");
			//number of rows
		...
		$('document').ready(function(){
			...
			$("#send").click(function(){
				...
				$.ajax({
					url: 'action.php',
					type: 'POST',
					data: {AirtestReportA: 1, tfrm: tfrm, tto: tto},
					success: function(data){
