  ...
  <body class="back">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse" style="background-color:#303F9F;">
          <ul class="nav navbar-nav">
				  ...
				  <li class="active"><a  href="patcancel.php"><i class="glyphicon glyphicon-remove"></i>&nbsp;Cancel Booking</a></li>
    ...
    <div class="container-fluid backs" style="margin-top:30px;">																																						
										  <div id="getProct">
											...
											<h3 style="color:white;">Cancel Booking</h3>
											<div id="viewapp"></div>										
	...
	<script>
		$(document).ready(function(){
			$("body").delegate(".delebooking","click",function(){
			var cid = $(this).attr("cid");
			$.ajax({
			url: "action.php",
			method: "post",
			data: {delebookings: 1, cid: cid
			},
