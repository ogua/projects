    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Add User</div>
				...
				<form method="POST" action="">
					...
					<div class="form-group">
						<input type="submit" name="send" value="Add User" class="btn btn-success">
					</div>
			...
			echo'<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" arialabel="close">&times;</a><strong>Failed! Username must start with upper case letter and cant contain numbers</strong></div>';
							...
							$sql="INSERT INTO `admin`(`username`, `password`) VALUES ('".$_POST['nameE']."','".$_POST['pwd']."')";
