...
<body class="back">
    <h1 class="text-center">Doctors Department</h1>
			...
			$sql = "SELECT * FROM `patients` WHERE `Ref`= '$id' ";
		   ...
		   <tbody>
				...
				' 
					<div class="alert alert-danger"> <a href="#" class="close" data-dismiss="alert" arialabel="close">&times;</a><strong>Failed to fetch information. no student id found </strong></div> 
				';
			}
			?>										   								 
