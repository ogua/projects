    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading"><a href="viewEvents.php" class="btn btn-info">&larr;</a> &nbsp; Event Details</div>
				<div class="panel panel-body">
					...
					<br>
						<p style="margin-left:80px;">'.$row['Description'].'</p>
					';
						...
						<form method="post" id="submitcomt">
							...
							<div class="form-group">
								<textarea cols="3" rows="5" class="form-control" placeholder="Enter Comment" name="commants" required></textarea>
							</div>
							<div class="form-group">
						...
						';
						$sqlc = "SELECT * FROM `comments` WHERE `Eventid` = '$id'";
						$queryc = mysqli_query($conn,$sqlc);
						if($queryc){
							echo'
							<h2 style="margin-left:80px;">Recent Comments</h2>
							<div id="displayComm" style="background:#ccc;border:2px solid blue;padding:20px;" class="col-md-10 col-md-offset-1">';
							while($rows = mysqli_fetch_array($queryc)){
								echo'
									<div class="media">
								  <div class="media-left">
									<a href="#">';
									if($rows['images'] =="default"){
										echo'<img src="images/co.png" class="media-object img-circle img-thumbnail" alt="Sample Image">';
									}else{
										echo'<img src="'.$rows['images'].'" class="media-object img-circle img-thumbnail" alt="Sample Image">';
									}
									echo'
									</a>
								  </div>
						  <div class="media-body">
							<h4 class="media-heading">'.$rows['Fullname'].'</h4>
							<h4 class="media-heading">'.$rows['Commentdate'].'</h4>										
							</div>
				...
				$.ajax({
					...
					success: function(data){
						if(data.match("success")){
							...
							window.location.href="eventpageview.php?evntid="+id;
