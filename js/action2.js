...
getCategory();
	...
	$("body").delegate(".keyyy", "keyup", function(){
		 var text = parseInt($(".key").val());
		 var text2 = parseInt($(".key2").val());
		 var ans = text * text2 ;
		 var text3 = $(".key3").val(ans);		 
	});
	...
	$("body").delegate("#Pages","click",function(){
		...
		$.ajax({
		 url : "action.php",
		 method : "post",
		 data: {getProds: 1, setPagess:1, id: id, cid: cid},
		 success: function(data){
			$("#getProct").html(data);
			$("#dispcatName").html("Books");
		 }
	...
	$("body").delegate(".getCateg", "click", function(){
		...
		$.ajax({
		 ...
		 success: function(data){
			$("#getProct").html(data.products);
			$("#pageno").html(data.paga);
		 }
		});
		$.ajax({
		 url : "action.php",
