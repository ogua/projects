		 ...
		 <?php
			if(isset($_POST['add'])){
				 ...
				 if(!password_verify($_POST['pass2'],$hash)){
					 ...
					 $sql = "INSERT INTO `admin`(`fullname`, `email`, `password`, `dates`) VALUES ('".$_POST['fullname']."','".$_POST['email']."','$hash',CURRENT_DATE)";
				 $query = mysqli_query($conn,$sql);
				 if($query){
					 echo '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" arialabel="close">&times;</a><strong>Admin Added Success!</strong> </div>';
				 }else{
