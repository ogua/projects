...
<link href="css/animate.css" rel="stylesheet" type="text/css" media="all">
 ...
 <body>
		 ...
		 <div class="contaner-fluid">
				...
				<div class="col-md-10" id="displayEr"></div>
				<div class="col-md-1"></div>
				</div>
				<div class="row">
						<div class="col-md-1"></div>
								...
								<div class="panel panel-info">
										...
										<div class="panel-body">
													...
													<div class="row">
															...
															<div class="col-md-12">
																<label class="label-control">Add Alternative Pickup</label>
															</div>
													...
													<div class="row">
															...
															<div class="col-md-6">
																	...
																	<input type="text" class="form-control" id="alNmae" name="alNmae" placeholder="ALETRNATIVE PICKUP fULLNAME" required>
															</div>
															<div class="col-md-6">
																	<label>Phone Number</label>
																	<input type="number" class="form-control" id="alNumb" name="alNumb" placeholder="ALETRNATIVE PICKUP PHONE NUMBER" required>
															</div>
													</div>
										</div>
										<div class="panel-footer" style="height:50px;">
										<input type="submit" name="creaCcc" id="creaCcc" value="Register" class="btn btn-success btn-sm pull-right"/></div>
								</div>
						</div>
						<div class="col-md-1"></div>
				</div>
