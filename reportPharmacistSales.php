    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Report On Pharmacist On Sales &nbsp;<span><img src="images/prescri.jpg" class="img-circle" height="50" width="50"></span></div>
				<div class="panel panel-body">
					 ...
					 <div class="form-group">
						<?php
							include_once('db.php');
							$sql = "SELECT * FROM `users` WHERE `role` = 'PHARMACIST'";
							$query = mysqli_query($conn,$sql);
							if($query){
								echo'<select name="pharma" id="pharma" class="form-control">
                   ...
                   <button type="submit"  style="border-bottom-left-radius:25px;" id="sdates" name="sdates" class="btn btn-success">SEARCH</button>	
				 </div>
		    </div>
					         ...
					         <table class="table table-striped"  border="1" >
						         <thead>
								     <tr>
										 ...
										 <th style="font-weight:bold;font-size:20px;">PHARMACIST</th>
							 ...
							 while($row2 = mysqli_fetch_array($query2)){
								 echo'
								     <tr>
										 ...
										 <td style="font-weight:bold;font-size:15px;">'.$row2['pharmacist'].'</td>
										 <td style="font-weight:bold;font-size:15px;">'.$row2['BillId'].'</td>
										 <td style="font-weight:bold;font-size:15px;">'.$row2['total'].'</td>
										 <td style="font-weight:bold;font-size:15px;">'.$row2['dates'].'</td>
									 </tr>';
									 $x++;
							 }
							 echo'</tbody>
...
<script>
		$('document').ready(function(){
			...
			$("#sdates").click(function(){
			var prname = $("#pharma").val();
			var results = $("#kwame").val();
			var resultss = $("#kwames").val();
			if(prname == ""){
				alert("Pharmacist Name Cant Be Empty");
				return;
			}
			if(results ==""){
				...
				return;
					...
					$.ajax({
						url: "pharmacistreport.php",
						method: "post",
						data: {prname: prname, results: results, resultss: resultss},
