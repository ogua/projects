						...
						<div class="col-md-2">
							...
							<div class="panel panel-body">
								<ul>
									...
									<li><hr style="2px solid #fff;"></li>
									<li><a href="ureport.php"><img src="images/customers.jpg" class="img-thumbnail" width="100" height="100"></a><a href="ureport.php" class="btn btn-info" style="width:100%;">Report</a></li>
								</ul>	
							</div>
...
tinymce.init({
	...
	<script>
		...
		$.ajax({
			url: 'action.php',
			type: 'POST',
			data: {getnerate5: 1, dfrom: dfrom, dto: dto},
			...
			$(document).on("click","#print_button2",function(){
