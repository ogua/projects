						...
						<div class="col-md-6">
							<form method="post" action="" id="addbranch">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="bcoNum" required>
								</div>
								<div class="form-group">
									<label>Branch State</label>
									<input type="text" class="form-control" name="bstate" required>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Add Branch">
								</div>
							</form>
						</div>
						<div class="col-md-6">
