...
public class ConfirmedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("All Confirmed Cases");
    ...
    private void loadsuspected() {
        ...
        Query query = reference.child("Case").orderByChild("Pcase").equalTo("Confirmed");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if (cases.getPcase().equals("Confirmed")){
                        suspected.add(cases);
    ...
    private void loadevents(final ProgressDialog pd) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!mEvents.isEmpty()){
                    adapter = new ContactsAdapter(mEvents,ConfirmedActivity.this);
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ConfirmedActivity.this, "No network Access", Toast.LENGTH_SHORT).show();
                pd.hide();
            }
        });
    }
