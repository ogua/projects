...
public class SuspectedCaseActivity extends AppCompatActivity {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if (cases.getPcase().equals("Suspected")){
                        suspected.add(cases);
    ...
    private void loadevents(final ProgressDialog pd) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!mEvents.isEmpty()){
                    adapter = new ContactsAdapter(mEvents,SuspectedCaseActivity.this);
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SuspectedCaseActivity.this, "No network Access", Toast.LENGTH_SHORT).show();
                pd.hide();
            }
        });
    }
