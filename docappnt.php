  ...
  <body class="back">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse" style="background-color:#303F9F;">
         ...
         <li ><a href="doctor.php"><i class="glyphicon glyphicon-user"></i>&nbsp;My Details</a></li>
										<li class="active"><a href="docappnt.php"><i class="glyphicon glyphicon-tasks"></i>&nbsp;My AppointMents</a></li>
    ...
    <div class="container-fluid back2" style="margin-top:30px;">				
										  <div id="getProct">
												...
												<h3 style="color:white;">My AppointMents</h3>
													<div id="docAppointmnt"></div>
