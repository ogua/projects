	...
	<div class="test_agile_info">
		...
		<div class="container-fluid">
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
						...
						<div class="col-md-2">
							...
							<div class="panel panel-body">
								<ul>
									...
									<li><a href="viewBooking.php"><img src="images/bookimg.png" class="img-thumbnail" width="100" height="100"></a><a href="viewBooking.php" class="btn btn-info" style="width:100%;">View Bookings</a></li>
									<li><hr style="2px solid #fff;"></li>
					...
					?>
							<div class="panel panel-info">
							<div class="panel panel-heading">Your Booking</div>
							<div class="panel panel-body" id="printRec">
								 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `booking`  WHERE `userid` = '".$_SESSION['id']."'");
			...
			<div class="table-responsive">
				<a href="booking2.php" class="btn btn-default" style="margin-top:10px;margin-left:20px;margin-bottom:10px;">&larr; Back</a>
		...
		';
			...
			echo'
				...
				echo $sql;
				exit;
				echo'<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" 				arialabel="close">&times;</a><strong>No hOSTEL bOOked Yet !</strong></div>';
			}
            ?>
							</div>
							<div class="panel panel-footer"></div>
