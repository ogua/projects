            ...
            <div class="row">
		        ...
		        <div class="col-md-4">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">Add Other Services Fees</h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		            <!-- form start -->
		       ...
		       <!-- second term -->
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">All Other Services</h3>
		            </div>
		            <!-- /.box-header -->
                      ...
                      @foreach($otherservce as $row)
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('edit_other_services',['id'=>$row->id]) }}" class="btn btn-info" ><i class='fa fa-pencil-square-o'></i>Edit</a>
                            <a href="{{ route('edit_other_services',['id'=>$row->id]) }}" class="btn btn-success" ><i class='fa fa-eye'></i>View</a>
                            <a href="{{ route('delete_other_services',['id'=> $row->id]) }}" onclick="return confirm('Are You Sure ?')" class="btn btn-danger"><i class='fa fa-trash-o'></i>Delete</a>
