		        ...
		        <div class="col-md-4">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">Edit Mandatory Fees</h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		            <!-- form start -->
                  <form method="post" role="form" action="{{route('save-mandatory-fees')}}" id="add-mandatory-fees">
                     ...
                     <div class="box-body">
                      ...
                      <input type="hidden" name="hiddenid" value="{{$mandatory->id}}">
                      @csrf

                      <div class="form-group  @error('title') has-error @enderror">
                             <label class="control-label" for="title">Fee Title</label>
                             <input type="text" value="{{$mandatory->title}}" class="form-control" name="title" id="title" placeholder="Enter ..." required>
