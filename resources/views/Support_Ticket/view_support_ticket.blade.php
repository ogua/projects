...
@section('main_content')
  ...
  <div class="col-md-4">
    <div class="box box-primary">
      ...
      <div class="box-body">
          <form class="" role="form" action="{{ route('post_basicinfo') }}" method="post">

                                <div class="form-group @error('department') has-error @enderror">
                                    <label for="e20">Change Department</label>
                                ...
                                <div class="form-group @error('status') has-error @enderror">
                                    ...
                                    <select name="status" class="form-control selectpicker">
                                        ...
                                        <option value="Pending" @if($st->status=='Pending') selected @endif>Pending</option>
                                        <option value="Answered" @if($st->status=='Answered') selected @endif>Answered</option>
                                        <option value="Customer Reply"  @if($st->status=='Customer Reply') selected @endif>Customer Reply</option>
                                        <option value="Closed"  @if($st->status=='Closed') selected @endif>Closed</option>
                                    </select>
                                </div>
                                <br>
                                @csrf
                                <input type="hidden" value="{{$st->id}}" name="cmd">
                                <button type="submit" class="btn btn-success btn-sm pull-right"><i class="fa fa-edit"></i>Update</button>
