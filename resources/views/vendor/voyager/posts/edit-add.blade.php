                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <input type="hidden" class="form-control" name="status" placeholder="status" value="{{ $dataTypeContent->status ?? 'PUBLISHED' }}">
                             </div>

                             <div class="form-group">
                                <input type="hidden" class="form-control" name="category_id" placeholder="category_id" value="{{ $dataTypeContent->category_id ?? '1' }}">
                             </div>

                            
                            <div class="form-group">
                                <input type="hidden" name="featured"@if(isset($dataTypeContent->featured) && $dataTypeContent->featured) checked="checked"@endif>
                            </div>
                        </div>
                    </div>
