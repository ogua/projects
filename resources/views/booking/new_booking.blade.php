...
@section('main_content')
    ...
    <div class="panel panel-info">
        <div class="panel panel-heading">New Booking </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group @error('appid')has-error @enderror">
                        ...
                        <input type="text" class="form-control" name="appid" value="{{ old('appid') }}" id="inputSuccess" placeholder="Enter ...">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group @error('age') has-error @enderror">
                        ...
                        <input type="number" class="form-control" value="{{ old('age') }}"  name="age" id="inputSuccess" placeholder="Enter ...">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group @error('appdate') has-error @enderror">
                        ...
                        <input type="date" class="form-control" value="{{ old('appdate') }}" name="appdate" id="inputSuccess" placeholder="Enter ...">
                ...
                <div class="form-group @error('apptime') has-error @enderror">
                        ...
                        <input type="time" class="form-control" value="{{ old('apptime') }}" name="apptime" id="inputSuccess" placeholder="Enter ...">
