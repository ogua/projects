            ...
            <div class="row">
		        ...
		        <div class="col-md-3">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">Record Postal Received</h3>
		            </div>
		            <!-- /.box-header -->
		            <!-- form start -->
		             	 <form method="post" role="form" action="{{route('save-postal-receive')}}" id="record-enqury" autocomplete="off" enctype="multipart/form-data">
		       ...
		       <!-- second term -->
		        ...
		        <div class="col-md-9">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">Postal Received List</h3>
		            </div>
		            <!-- /.box-header -->
		                	...
		                	@foreach($dispatches as $dispatch)
		                		<tr>
		                			...
		                			<td>{!!$dispatch->doc ? 
		                			 ...
		                			 <td>
					                  	<a href="{{route('edit-postal-receive', ['id'=>$dispatch->id])}}" class="btn btn-info" ><i class='fa fa-pencil-square-o'></i>Update</a>
					                  	<a href="{{route('delete-postal-receive', ['id'=>$dispatch->id])}}" onclick="return confirm('Are You Sure ?')" class="btn btn-danger" ><i class='fa fa-trash'></i>Delete</a>
					                  </td>
		                		</tr>
		                	@endforeach
		                </tbody>
