...
@section('mtitle')
  Online Admissions Approved For Level 200
@endsection
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Level 200 Online Admissions </h3>
      </div>
      <div class="box-body">
...
<script type="text/javascript">
	...
	$('#admission').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('admissions-all-level2-app') }}',
        dom: 'lBfrtip',
        buttons: [
            'copy',
            'csv',
        ...
        columns: [
            ...
            {data: 'approve', render: function(data,type,row,meta){
                $html = "";
                $html += '<span class="badge badge-light">Approved</span';
                return $html;
            }, 
             orderable: false
        },
