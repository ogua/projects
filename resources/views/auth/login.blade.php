...
@section('infos')
<img src="{{URL::to('web/images/stellalogo.png')}}" class="user-image" alt="User Image">
@endsection
...
<div class="login-box-body">
  ...
  <form  action="{{ route('login') }}" method="post">
    ...
    {{-- <div class="social-auth-links text-center">
      ...
      <a href="{{ route('webhome') }}" class="text-center" style="margin-left: 10px;">Return To Website </a>                            
