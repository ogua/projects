            ...
            <div class="col-md-4">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                    ...
                    <form method="post" action="{{route('update-polls')}}" >
                      @csrf
                      <input type="hidden" name="hiddenid" value="{{$type->id}}">
                      <div class="form-group  @error('polltype') has-error @enderror">
                             <label class="control-label" for="inputError">Polls Type</label>
                             <input type="text" class="form-control" value="{{$type->type}}" name="polltype" id="inputError" placeholder="Enter ...">
                              <span class="help-block">@error('polltype') {{ $message }} @enderror</span>
                        </div>
                        <input type="submit" name="submit" value="Update Polls" class="btn btn-success">
