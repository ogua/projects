            ...
            <div class="row">
		        ...
		        <div class="col-md-4">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">Create Staff Meeting</h3>
		            </div>
		            <!-- /.box-header -->
		            <!-- form start -->
		             	 <form method="post" role="form" action="{{route('staff-meeting-save')}}" id="create-meeting">
		             	 	 <div class="box-body">
								@csrf
		       ...
		       <!-- second term -->
		        ...
		        <div class="col-md-8">
		          ...
		          <div class="box box-primary">
		            <div class="box-header with-border">
		              <h3 class="box-title">All Staff Meetings</h3>
		            </div>
		            <!-- /.box-header -->
		             <div class="box-body">
                 ...
                 $.ajax({
                    ...
                    success: function(data){ 
                    	if (data == 'true') {
                    		...
                    		swal("Failed! Meeting Cant Only Be Deleted By The Creator",{
	                        	icon: 'warning',
	                        });
                    	}
