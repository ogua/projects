 ...
 <ul class="sidebar-menu" data-widget="tree">
        ...
        @hasanyrole('Lecturer|is_superAdmin|is_admin') 
         <li class="@if(Request::segment(1) == 'OnlineExamination')
                    active                  
                  @endif treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Add Mandatory Fees</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>All Mandatory Fees</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Add Other Services</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>All Services</a></li>
