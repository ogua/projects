  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Enter Student Results</h3>
      </div>
      <div class="box-body">
        <form action="{{ route('lecturer-student-results-save') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-4">
            ...
            <input type="submit" class="btn btn-info" value="Add Results">
            </form>
      </div>
    </div>
  </div>
