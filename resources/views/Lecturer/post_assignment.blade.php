  ...
  <div class="col-md-4">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Post Assignment</h3>
      </div>
      <div class="box-body">
          <form method="post" action="{{route('lecturer-student-assignment-post')}}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group  @error('coursecode') has-error @enderror">
            ...
            <div class="form-group  @error('assignmenttitle') has-error @enderror">
                 ...
                 <input type="text"  value="{{ old('assignmenttitle') }}" class="form-control" name="assignmenttitle" id="inputError" placeholder="Enter ...">
             ...
             <div class="form-group  @error('assignmentdesc') has-error @enderror">
                 ...
                 <textarea cols="4" rows="4" name="assignmentdesc" class="form-control">{{old('assignmentdesc')}}</textarea>
            ...
            <div class="form-group  @error('deadline') has-error @enderror">
                 ...
                 <input type="date"  value="{{ old('deadline') }}" class="form-control" name="deadline" id="inputError" placeholder="Enter ...">
            ...
            <input type="submit" name="submit" value="Post Assignment" class="btn btn-success">
        </form> 
      </div>
    </div>
  </div>
