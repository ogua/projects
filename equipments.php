    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Add Equipment</div>
						...
						<div class="col-md-6">
							<form method="post" action="" id="adduser" enctype="multipart/form-data">
								<div class="form-group">
									<label>Image Of Equipment</label>
								...
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Add Equipment">
								</div>
							</form>
						</div>
					</div>
				...
				$.ajax({
					...
					success: function(data){
						if(data.match("sucess")){
							alert("Farm Equipment Added Successfully!");
