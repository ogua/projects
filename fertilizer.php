    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">Add Fertilizer</div>
							...
							<form method="post" action="" id="adduser" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<select name="purpose" class="form-control" required>
										...
										<option value="Foler">Foler</option>
									</select>
								</div>
								<div class="form-group">
									<label>Description</label>
									<textarea name="decsrp" rows="3" cols="3" class="form-control"></textarea>
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-info" name="addb" value="Record Fertilizer">
								</div>
							</form>
						</div>
					</div>
				...
				$.ajax({
					...
					success: function(data){
						if(data.match("sucess")){
							alert("Fertilizer Recordered Successfully!");
