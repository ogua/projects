			...
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					<ul class="list-inline">
						...
						<li><a href="Editpassword.php" class="btn btn-info" style="width:100%;">Edit Password</a></li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-info">
							<div class="panel panel-heading">Edit Password</div>
							<div class="panel panel-body">
								<div class="row">
									<div class="col-md-8">
										<form action="#" method="post" id="ChangePas">
											<div class="form-group">
												<input class="form-control" type="email" name="Email" placeholder="Enter Your Email" required>
											</div>
											<div class="form-group">
												<input class="form-control" type="password" name="password" placeholder="Enter Your Password" required style="color:black;">
											</div>
											<div class="form-group">
												<input class="form-control" type="password" name="password2" placeholder="ReEnter Password" required style="color:black;">
											</div>
...
tinymce.init({
	...
	<script>
	$(document).ready(function(){	
	$("#ChangePas").on("submit",function(e){
		e.preventDefault();
		$.ajax({
			url: 'updatepasshostel.php',
			type: 'POST',
			contentType: false,
			processData: false,
			cache: false,
