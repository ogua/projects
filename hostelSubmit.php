  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
		 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `hostels`");
			$row = mysqli_fetch_assoc($sqlAll);
			$allrow = $row['numofrows'];
			//get rows query
			$query = mysqli_query($conn, "SELECT * FROM `hostels`");
			//number of rows
			...
			<div class="table-responsive">
				...
				<button class="btn btn-default">Total Hostels&nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button>	
			...
			$(".delecthostel").click(function(){
				...
				$.ajax({
					...
					success: function(data){
						alert(data);
						window.location.href="hostelSubmit.php";
					}
				});
			});
		});
