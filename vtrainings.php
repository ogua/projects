    ...
    <section class="content">
      ...
      <div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel panel-heading">View Training Sessions</div>
				<div class="panel panel-body">
					 <?php
            include('db.php');
			$sqlAll = mysqli_query($conn,"SELECT count(*) as numofrows FROM `training`");
			...
			<div class="table-responsive">
				<button class="btn btn-default">Total training Sessions&nbsp;<span style="font-size:1.0em;"class="badge">'.$allrow.'</span></button>
				<a href="trainings.php" class="btn btn-default">Record New training Session&nbsp;<i class="fa fa-plus"></i></a>
				<table class="table table-striped"  border="1" cellpadding="10">
					<tr>
						<th>ID</th>
						<th>Purpose of Training</th>
						<th>Placeof Training</th>
						<th>Start Date</th>
						<th>End Date</th>
						<th>Date Added</th>
						<th>Del</th>
...
<script>
		$('document').ready(function(){
			...
			$(".deluser").click(function(e){
				...
				//alert(cid);
				if(confirm("Are you sure you want to delect this Training Session")){
					$.ajax({
						url: 'action.php',
						type: 'POST',
						data: {DelTraining: 1, cid: cid},
						success: function(data){
							if(data.match("success")){
								alert("Training Session Delected Successfully!");
								window.location.href="vtrainings.php"
							}else{
